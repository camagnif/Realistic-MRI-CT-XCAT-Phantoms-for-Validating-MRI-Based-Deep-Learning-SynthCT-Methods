...
for index in id_ph:
    ...
    dir_fakeMRI = folder_MRI_corrected + str(index) + '_fakeMRI_' + str(desired) + '_corr.mha'
...
path = '//NAS-CARTCAS/camagnif/tesi/FINAL_RESULTS/MRI/' + desired + '/fakeMRI_paired_' + desired + '_metrics_348x348.xlsx'
